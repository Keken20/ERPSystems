...
namespace ERPSystem.Data
{
    ...
    {
        private string connectionString = @"Data Source=DESKTOP-IFRPMGB\SQLEXPRESS01;Initial Catalog=erpsystem;Integrated Security=True";
        ...
        public List<Supplier> GetAll()
        {
            ...
            {
                string sqlQuery = "SELECT * FROM dbo.Supplier WHERE SUPPISACTIVE = 1";
